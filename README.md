...
This fork of the [Marlin firmware](https://github.com/MarlinFirmware/Marlin) contains my configuration and build to accomodate my custom hardware modifications. If you share the same hardware or if you are considering acquiring it, than you might be interested in digging into this repository.
